...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_output_t, stringdata) + ofs \
...
const QMetaObject output::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_output.data,
      qt_meta_data_output,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *output::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_output.stringdata))
